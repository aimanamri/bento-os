...
| 9.6 | Metadata panel visibility across modes | Unaffected by Reading/Editor mode — Label, Tags, Fields, Created/Modified, and URL list all stay visible and editable in either mode. Reading/Editor mode only concerns the body-authoring chrome, not metadata. |
